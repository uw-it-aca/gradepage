...
class ExceptionsTest(TestCase):
    ...
    def test_GradingPeriodNotOpen(self):
        try:
            ...
            self.assertEqual(
                str(ex), "Grade submission is not open for this section.")
    ...
    def test_InvalidCSV(self):
        try:
            ...
            self.assertEqual(str(ex), "Missing header")

        try:
            raise InvalidCSV()
        except InvalidCSV as ex:
            self.assertEqual(str(ex), "Invalid CSV file")
